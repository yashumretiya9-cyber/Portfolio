  ...
  useEffect(() => {
    ...
    const handleClick = (e) => {
      const target = e.target.closest(
        ".proj-btn, .sayhi, .sm-socials-link, .theme-toggle-btn, .lg-link",
      );
      if (target) {
    ...
    <>
      ...
      <div className="bg-decoration">
        ...
        <svg className="tech-lines" width="100%" height="100%">
          ...
          <path
            className="tech-path"
            d="M100,0 L100,200 L150,250 L150,500 L100,550 L100,1000"
          />
          <path
            className="tech-path"
            d="M1000,300 L800,300 L750,350 L500,350 L450,300 L0,300"
          />
          <path
            className="tech-path"
            d="M900,1000 L900,800 L850,750 L850,500 L900,450 L900,0"
          />
        </svg>
